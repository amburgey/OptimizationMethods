...
##### POSTBT2 - 2009 project
##### The purpose of this code is to prepare this dataset for spatial capture recapture analysis

source("Real Data Analysis/Trapping/DataPrep/DataPrepCPPOSTBT2.R")    ## Functions to reshape survey and capture data
...
CPcaps <- subset(CPcaps, PROJECTCODE == "POST BT2 TRAP")
CPsurv <- subset(CPsurv, PROJECTCODE == "POST BT2 TRAP")

## SECIFY TIME FRAME
time <- c("09","10")
time2 <- c("2009-08-01","2009-11-30")
...
#### PREP DATA FOR SCR ANALYSIS - DO HERE AND USE FOR ALL STUDIES IN CP ####
