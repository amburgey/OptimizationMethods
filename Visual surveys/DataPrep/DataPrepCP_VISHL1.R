...
prepSCRman <- function(SCRcaps, SCReff, grid){
  ...
  act2[act2$GridID == "81",24] <- 0  ##W5
  act2[act2$GridID == "82",24] <- 0  ##W6
  act2[act2$GridID == "83",24] <- 0  ##W7
  act2[act2$GridID == "84",24] <- 0  ##W8
  act2[act2$GridID == "85",24] <- 0  ##W9
  act2[act2$GridID == "86",24] <- 0  ##W10
  act2[act2$GridID == "87",24] <- 0  ##W11
  act2[act2$GridID == "88",24] <- 0  ##W12
  act2[act2$GridID == "89",24] <- 0  ##W13
