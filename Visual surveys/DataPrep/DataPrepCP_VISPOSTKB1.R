...
prepSCRman <- function(SCRcaps, SCReff, grid){
  ...
  # fullX[grep("W", fullX$Point),]
  act2[act2$GridID == "77",22] <- 0  ##W1
  act2[act2$GridID == "78",22] <- 0  ##W2
  act2[act2$GridID == "79",22] <- 0  ##W3
  act2[act2$GridID == "80",22] <- 0  ##W4
  act2[act2$GridID == "81",22] <- 0  ##W5
  act2[act2$GridID == "82",22] <- 0  ##W6
  act2[act2$GridID == "83",22] <- 0  ##W7
  act2[act2$GridID == "84",22] <- 0  ##W8
  act2[act2$GridID == "85",22] <- 0  ##W9
  act2[act2$GridID == "86",22] <- 0  ##W10
  act2[act2$GridID == "87",22] <- 0  ##W11
