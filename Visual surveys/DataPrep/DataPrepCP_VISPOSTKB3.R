...
prepSCRman <- function(SCRcaps, SCReff){
  ...
  act2[act2$Point == "C1",4] <- 0
  act2[act2$Point == "C2",4] <- 0
  act2[act2$Point == "C3",4] <- 0
  act2[act2$Point == "C4",4] <- 0
  act2[act2$Point == "C5",4] <- 0
  act2[act2$Point == "C6",4] <- 0
  act2[act2$Point == "AA1",4] <- 0
  act2[act2$Point == "AA2",4] <- 0
  act2[act2$Point == "AA3",4] <- 0
  act2[act2$Point == "AA4",4] <- 0
  act2[act2$Point == "AA5",4] <- 0
  act2[act2$Point == "AA6",4] <- 0
