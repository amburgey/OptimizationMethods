...
prepSCRman <- function(SCRcaps, SCReff, grid){
  ...
  # fullX[grep("C", fullX$Point),]
  # fullX[grep("AA", fullX$Point),]
  act2[act2$GridID == "377",4] <- 0  ##C1
  act2[act2$GridID == "378",4] <- 0  ##C2
  act2[act2$GridID == "379",4] <- 0  ##C3
  act2[act2$GridID == "380",4] <- 0  ##C4
  act2[act2$GridID == "381",4] <- 0  ##C5
  act2[act2$GridID == "382",4] <- 0  ##C6
  act2[act2$GridID == "17",4] <- 0  ##AA1
  act2[act2$GridID == "18",4] <- 0  ##AA2
  act2[act2$GridID == "19",4] <- 0  ##AA3
  act2[act2$GridID == "20",4] <- 0  ##AA4
  act2[act2$GridID == "21",4] <- 0  ##AA5
  act2[act2$GridID == "22",4] <- 0  ##AA6
