...
# save(out, file="Visual surveys/Results/NWFNVISHL1_SCRpstarvisCATsizeCAT.Rdata")
save(out, file="Visual surveys/Results/NWFNVISHL1_SCRpstarvisCATNOSIZEgrid5.Rdata")
