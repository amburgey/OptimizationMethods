...
save(out, file="Visual surveys/Results/NWFNVIS2_SCRpstarvisCATsizeCATonly1size.Rdata")
# save(out, file="Visual surveys/Results/NWFNVIS2_SCRpstarvisCATNOSIZEgrid5.Rdata")
