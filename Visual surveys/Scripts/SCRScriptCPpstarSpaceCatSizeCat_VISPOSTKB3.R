...
# inits <- function(){
#   list (sigma=runif(1,30,40), n0=c(n+10), s=vsst, p0=runif(L,.002,.003))
# }
inits <- function(){
...
# save(out, file="Visual surveys/Results/NWFNVISPOSTKB3_SCRpstarvisCATsizeCATupdatedgrid10.Rdata")  ## M = 150 (XXXXhrs)
save(out, file="Visual surveys/Results/NWFNVISPOSTKB3_SCRpstarvisCATNOSIZEgrid10.Rdata")
