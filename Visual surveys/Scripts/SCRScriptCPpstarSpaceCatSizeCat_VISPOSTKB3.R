...
## MCMC settings
nc <- 3; nAdapt=200; nb <- 100; ni <- 3500+nb; nt <- 1  ## hits error at 2000 iter, 1000 adapt
...
inits <- function(){
  list (sigma=runif(1,30,40), n0=c(29,7,42,7), s=vsst, p0=runif(L,.002,.003))
}
...
save(out, file="Visual surveys/Results/NWFNVISPOSTKB3_SCRpstarvisCATsizeCATonly2sizes.Rdata")  ## M = 150 (XXXXhrs)
