...
SCRcaps <- subYr(SITEcaps=capPROJ, time=time)  ## Changes depending upon time span set above
...
",file = "Visual surveys/Models/SCRpstarCAT_CPTruncationPoints.txt")
...
inits <- function(){
  list (sigma=runif(1,30,40), n0=nind, s=vsst, p0=runif(1,.002,.003))
}
