...
",file = "Trapping/Models/SCRpstarCATsizeCAT.txt")

#######################################################

## MCMC settings
nc <- 3; nAdapt=200; nb <- 100; ni <- 100+nb; nt <- 1
