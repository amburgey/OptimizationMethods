...
CPcaps <- subset(CPcaps, PROJECTCODE == "NWFN TRAP 3")
CPsurv <- subset(CPsurv, PROJECTCODE == "NWFN TRAP 3")

## SECIFY TIME FRAME
time <- c("03","05")  ## actually under 2 months due to late start in March
time2 <- c("2007-02-01","2007-06-31")
...
# 
# ## For Size model:
# save(out, file="Trapping/Results/NWFNTRAP3_SCRpstartrapCATsizeCAT.Rdata")
# ## For No Size model:
# # save(out, file="Trapping/Results/NWFNTRAP3_SCRpstartrapCATNOSIZEgrid10.Rdata")
