...
source("Trapping/DataPrep/DataPrepCPPOSTBT2.R")    ## Functions to reshape survey and capture data
...
# 
# ## For Size model:
# save(out, file="Trapping/Results/NWFNPOSTBT2TRAP_SCRpstartrapCATsizeCAT.Rdata")
# ## For No Size model:
