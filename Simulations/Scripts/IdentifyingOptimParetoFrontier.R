...
library(ggplot2);library(tidyverse);library(dplyr);library(ggrepel)
...
fullcost <- merge(startup, perfcost2, by = c("Code2"))
fullcost$TotalCost <- fullcost$Cost.x + fullcost$Cost.y

## Scenario One: Full start-up costs (aka, no equipment already purchased) plus recurring costs

## Root Mean Square Error (RMSE) - square root of the mean of the square of all error, lower value indicates more accuracy
## For normal BTS density
pareto120FULL <- ggplot(subset(fullcost, Truth == 120), aes(x = TotalCost, y = RMSE, fill = TypeALL, shape = Scenario.y, size = as.factor(Size))) + #, label=Sim
  geom_jitter(alpha = 0.75) + 
  xlab("Cost in USD") + ylab("Root Mean Square Error") +
  theme(axis.title = element_text(size = 12), axis.text = element_text(size = 10)) +
  scale_fill_manual(values = c("#799D31","#B77A29","#C9F277","#FDEC9E"), breaks = c("closedTRAP","closedVIS","onewayTRAP","onewayVIS")) +
...
## For low BTS density
pareto60FULL <- ggplot(subset(fullcost, Truth == 60), aes(x = TotalCost, y = RMSE, fill = TypeALL, shape = Scenario.y, size = as.factor(Size))) + #, label=Sim
  geom_jitter(alpha = 0.75) +
  xlab("Cost in USD") + ylab("Root Mean Square Error") +
  theme(axis.title = element_text(size = 12), axis.text = element_text(size = 10)) +
  scale_fill_manual(values = c("#799D31","#B77A29","#C9F277","#FDEC9E"), breaks = c("closedTRAP","closedVIS","onewayTRAP","onewayVIS")) +
...
## Root Mean Square Error (RMSE) - square root of the mean of the square of all error, lower value indicates more accuracy
## For normal BTS density
pareto120HALF <- ggplot(subset(fullcost, Truth == 120), aes(x = (TotalCost-(Cost.x/2)), y = RMSE, fill = TypeALL, shape = Scenario.y, size = as.factor(Size))) + #, label=Sim
  geom_jitter(alpha = 0.75) + 
  xlab("Cost in USD") + ylab("Root Mean Square Error") +
  theme(axis.title = element_text(size = 12), axis.text = element_text(size = 10)) +
  scale_fill_manual(values = c("#799D31","#B77A29","#C9F277","#FDEC9E"), breaks = c("closedTRAP","closedVIS","onewayTRAP","onewayVIS")) +
...
## For low BTS density
pareto60HALF <- ggplot(subset(fullcost, Truth == 60), aes(x = (TotalCost-(Cost.x/2)), y = RMSE, fill = TypeALL, shape = Scenario.y, size = as.factor(Size))) + #, label=Sim
  geom_jitter(alpha = 0.75) +
  xlab("Cost in USD") + ylab("Root Mean Square Error") +
  theme(axis.title = element_text(size = 12), axis.text = element_text(size = 10)) +
  scale_fill_manual(values = c("#799D31","#B77A29","#C9F277","#FDEC9E"), breaks = c("closedTRAP","closedVIS","onewayTRAP","onewayVIS")) +
...
## Root Mean Square Error (RMSE) - square root of the mean of the square of all error, lower value indicates more accuracy
## For normal BTS density
pareto120NONE <- ggplot(subset(fullcost, Truth == 120), aes(x = (TotalCost-Cost.x), y = RMSE, fill = TypeALL, shape = Scenario.y, size = as.factor(Size))) + #, label=Sim
  geom_jitter(alpha = 0.75) + 
  xlab("Cost in USD") + ylab("Root Mean Square Error") +
  theme(axis.title = element_text(size = 12), axis.text = element_text(size = 10)) +
  scale_fill_manual(values = c("#799D31","#B77A29","#C9F277","#FDEC9E"), breaks = c("closedTRAP","closedVIS","onewayTRAP","onewayVIS")) +
...
## For low BTS density
pareto60NONE <- ggplot(subset(fullcost, Truth == 60), aes(x = (TotalCost-Cost.x), y = RMSE, fill = TypeALL, shape = Scenario.y, size = as.factor(Size))) + #, label=Sim
  geom_jitter(alpha = 0.75) +
  xlab("Cost in USD") + ylab("Root Mean Square Error") +
  theme(axis.title = element_text(size = 12), axis.text = element_text(size = 10)) +
  scale_fill_manual(values = c("#799D31","#B77A29","#C9F277","#FDEC9E"), breaks = c("closedTRAP","closedVIS","onewayTRAP","onewayVIS")) +
